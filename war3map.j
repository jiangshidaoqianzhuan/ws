...
function Trig______________010Actions takes nothing returns nothing
    ...
    call SaveInteger(YDHT, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
    call SaveInteger(YDHT, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    if ( ( GetUnitTypeId(GetAttackedUnitBJ()) == 'n014' ) and ( ( GetUnitTypeId(GetEventDamageSource()) == 'Hblm' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n00S' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n00O' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n00Z' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n011' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n00X' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n013' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n012' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n00W' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n00P' ) or ( GetUnitTypeId(GetEventDamageSource()) == 'n010' ) ) ) then
...
function InitTrig______________012 takes nothing returns nothing
    ...
    call TriggerRegisterAnyUnitEventBJ(gg_trg______________012, EVENT_PLAYER_HERO_SKILL)
...
function Trig______________013Actions takes nothing returns nothing
    if ( ( GetUnitTypeId(GetConstructedStructure()) == 'n014' ) ) then
        ...
        call UnitAddAbility(GetConstructedStructure(), 'A00A')
    else
    endif
endfunction
//===========================================================================
...
call ExecuteFunc("jasshelper__initstructs73805640")
...
function jasshelper__initstructs73805640 takes nothing returns nothing
